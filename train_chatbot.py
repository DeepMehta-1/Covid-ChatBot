...
# lemmatize: convert each word into the lower case and remove duplicates
words_mod = [word_lemmatizer.lemmatize(w.lower()) for w in words_mod if w not in ignore_words]
...
for doc in documents:
    ...
    pattern_words = [word_lemmatizer.lemmatize(word.lower()) for word in pattern_words]
...
sgd_model = SGD(lr=0.01, decay=1e-6, momentum=0.9, nesterov=True)
